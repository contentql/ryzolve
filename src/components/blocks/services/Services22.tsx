    ...
    <Fragment>
      <div className="row">
        <div className="col-md-10 offset-md-1 col-lg-8 offset-lg-2 mx-auto text-center">
          <h2 className="fs-16 text-uppercase text-muted mb-3">Why Choose ryzolve?</h2>
      ...
      <div className="tab-content mt-6 mt-lg-8">
        <div className="tab-pane fade active show" id="tab2-1" role="tabpanel">
          <div className="row gx-lg-8 gx-xl-12 gy-10 align-items-center">
            ...
            <List title="Collect Ideas" color="orange" />
          </div>
        </div>
...
type ListProps = { color: 'fuchsia' | 'violet' | 'green' | 'orange'; title: string, description?: string };
