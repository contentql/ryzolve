...
export const serviceList11 = [
  {
    ...
    description: `Electronic Document Management that suites to fit your healthcare structure to increase Efficiency,Electronic Document Management that suites to fit your healthcare structure to increase Efficiency`,
  },
  {
    id: 2,
    link: '#',
