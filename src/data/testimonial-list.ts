...
export const testimonialList2 = [
  {
    ...
    review:
      "Suspendisse nec sapien sit amet nunc euismod tincidunt vel sed orci. Morbi scelerisque vel ante nec convallis. Sed neque eros, volutpat ut augue quis, lacinia ornare felis. Donec molestie nunc varius est blandit, nec pretium libero tincidunt eget porta nibh.",
  },
  {
    name: "Lisa Simpson",
